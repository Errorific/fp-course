...
lift3 ::
  ...
  -> f c
  -> f d
lift3 ff fa fb fc = lift2 ff fa fb <*> fc
...
lift4 ::
  ...
  -> f d
  -> f e
lift4 ff fa fb fc fd = lift3 ff fa fb fc <*> fd
...
filtering ::
  ...
  -> f (List a)
filtering fa = let
  addIfTrue a True accElem = a :. accElem
  addIfTrue _ False accElem = accElem
  in foldRight (\a acc -> (addIfTrue a <$> fa a) <*> acc) (pure Nil)
